...
Reproduzir, durante a aula, os códigos dos conteúdos apresentados em:
...
```{python}
#comentei para poder renderizar
#!pip install polars
...
Exemplo: Quais são as médias da variável valor1 e o valor mínimo da variável valor2 para cada um dos grupos definidos por grupo?
...
voos = pl.read_csv("dados/flights.csv",
                  ...
                  schema_overrides={"AIRLINE": pl.Utf8, "ARRIVAL_DELAY": pl.Int32, "DESTINATION_AIRPORT": pl.Utf8})
voos.shape
```
